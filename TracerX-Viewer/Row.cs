...
namespace TracerX.Viewer {
    ...
    internal class Row {
        ...
        public ViewItem MakeItem(Row previousRow) {
            ...
            if (Settings.Default.ColoringEnabled && Settings.Default.ColoringRules != null) {
                ColoringRule rule = MatchColoringRule();
                if (rule != null) {
                    item.BackColor = item.BColor = rule.BackColor;
                    item.ForeColor = item.TColor = rule.TextColor;
                }
            }
        ...
        private ColoringRule MatchColoringRule() {
            ...
            foreach (ColoringRule rule in Properties.Settings.Default.ColoringRules) {
                if (rule.Enabled) {
                    ...
                    if (rule.Fields == ColoringFields.All || (rule.Fields & ColoringFields.Method) == ColoringFields.Method) {
                        if (method == null) method = Rec.MethodName;
        ...
        private void SetFields(Row previousRow) {
            ...
            if (mainForm.headerLevel.ListView != null) {
                _fields[mainForm.headerLevel.Index] = Rec.Level.ToString();
            }
            ...
            if (mainForm.headerMethod.ListView != null) {
                _fields[mainForm.headerMethod.Index] = Rec.MethodName;
            }
        }
